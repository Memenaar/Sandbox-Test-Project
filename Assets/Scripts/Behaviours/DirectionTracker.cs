...
// 2. Uses the correct sprite relative to the facing direction of the in-game object and angle of the camera.
	...
	public class DirectionTracker : MonoBehaviour
	{
		...
		private Transform _navTransform;
		...
		void Awake()
		{
			...
			_sprite = transform.parent.Find("Billboard").GetComponent<SpriteRenderer>();
		...
		{
			Vector2 _navRotation = _navTransform.eulerAngles;
