...
public class SceneLoader : MonoBehaviour
{
    ...
    private void LocationColdStartup(GameSceneSO currentlyOpenedLocation, bool showLoadingScreen, bool fadeScreen)
    {
        ...
        {
            // Gameplay Manager is loaded synchronously
    ...
    private void LoadLocation(GameSceneSO locationToLoad, bool showLoadingScreen, bool fadeScreen)
    {
        ...
        if (_gameplayManagerSceneInstance.Scene.isLoaded || !_gameplayManagerSceneInstance.Scene.isLoaded)
        {
            _gameplayManagerLoadingOpHandle = _gameplayScene.sceneReference.LoadSceneAsync(LoadSceneMode.Additive, true);
    ...
    private void LoadMenu(GameSceneSO menuToLoad, bool showLoadingScreen, bool fadeScreen)
    {
        ...
        // In case we're coming from a Location back to the main menu, we need to get rid of the persistent Gameplay manager scene.
    ...
    private IEnumerator UnloadPreviousScene()
    {
        ...
        if (_currentlyLoadedScene != null) // Null when the game is started in Initialisation
        {
    ...
    {
        //_onSceneReady.RaiseEvent(); // Spawn system will spawn player character in a gameplay scene. Not relevant yet.
    }
