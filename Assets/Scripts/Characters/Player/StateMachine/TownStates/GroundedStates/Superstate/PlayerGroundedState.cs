...
public class PlayerGroundedState : PlayerBaseState
{
    ...
    public override void CheckSwitchStates()
    {
        ...
        }else if (_ctx.PlayerInteraction)
        {
    ...
    private void PlayerRun()
    {
        ...
        {
            _ctx.TurnLerp = Mathf.Lerp(_ctx.TurnLerp, _ctx.PlayerID.RunLerp, Time.deltaTime);
            _ctx.Acceleration = Mathf.Lerp(_ctx.Acceleration, _ctx.PlayerID.RunAccel, Time.deltaTime);
            _ctx.Drag = Mathf.Lerp(_ctx.Drag, _ctx.PlayerID.RunDrag, Time.deltaTime);
            _ctx.JumpSpeed = Mathf.Lerp(_ctx.JumpSpeed, _ctx.PlayerID.RunJump, Time.deltaTime);
        } else {
            _ctx.TurnLerp = Mathf.Lerp(_ctx.TurnLerp, _ctx.PlayerID.WalkLerp, Time.deltaTime);
            _ctx.Acceleration = Mathf.Lerp(_ctx.Acceleration, _ctx.PlayerID.WalkAccel, 0.5f * Time.deltaTime);
            _ctx.Drag = Mathf.Lerp(_ctx.Drag, _ctx.PlayerID.WalkDrag, 0.5f * Time.deltaTime);
            _ctx.JumpSpeed = Mathf.Lerp(_ctx.JumpSpeed, _ctx.PlayerID.WalkJump, Time.deltaTime);
        }
    }
